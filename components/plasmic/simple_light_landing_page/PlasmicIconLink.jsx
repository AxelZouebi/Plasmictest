...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: 5nsAC-97wD1kH/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__p4Uk)}
              role={"img"}
            />
          ),
