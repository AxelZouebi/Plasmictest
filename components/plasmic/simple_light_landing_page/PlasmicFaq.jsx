...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: uCf9zOyh2sQ59H/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__ftN5K)}
      >
        <div className={classNames(defaultcss.all, sty.box__wJDzm)}>
          <div className={classNames(defaultcss.all, sty.box__mpSHt)}>
            {p.renderPlasmicSlot({
