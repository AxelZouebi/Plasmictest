...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: xJJgL0x6WV_tx/css
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: _n33xcMEkLmMP7/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__u5EaW)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__goQo)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__aZaNj)}>
          <SphereIcon
