...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: T_w4bTg5lQRFO8/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__aScLm, {
          [sty.box__long__aScLml9BuF]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__ceCa7, {
            [sty.box__long__ceCa7L9BuF]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg___1Q2Jb)}
                role={"img"}
              />
            ),
