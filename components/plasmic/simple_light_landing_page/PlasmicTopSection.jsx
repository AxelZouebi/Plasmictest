...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: zvJ6W4Z5HmfR1/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__nRf5A)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__irtiE)}
        >
          <div className={classNames(defaultcss.all, sty.box__dDkv)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__vDxl)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__cyfO8)}
            text={"Start free trial"}
            type={"solidBlue"}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__cPguK)}
            text={"Learn more"}
            type={"solidBlack"}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__jZbC6)}>
          <img
